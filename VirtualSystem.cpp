...
void VirtualSystem::Init ( PrimitiveBuilder* primitive_builder )
{
	...
	for (int i = 0; i < num_markers; i++)
	{
		...
		marker->scale_ = gef::Vector4 ( 0.1f, 0.1f, 0.01f );
...
bool VirtualSystem::Update ( float frame_time )
{
...
void VirtualSystem::Render ( gef::Renderer3D* renderer_3d )
{
...
void VirtualSystem::AdvanceControl ()
{
...
void VirtualSystem::ProcessKeyboardInput ( gef::Keyboard* keyboard, float frame_time )
{
	if (keyboard)
	{
		float accel = 1.0f;
